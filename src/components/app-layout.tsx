  ...
  return (
    <TooltipProvider>
      <div className="flex min-h-screen w-full flex-col bg-background" dir="rtl">
        ...
        {isMounted && !isCarrierPath && <nav className="sticky top-16 z-40 hidden h-12 items-center justify-center gap-8 border-b bg-[#F5F4D7] px-6 text-black shadow-sm md:flex">
          {menuItems.map((item) => {
